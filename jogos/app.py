...
from routes.jogos_routes import jogos_routes # Importa as rotas do módulo de carros
...
app.register_blueprint(jogos_routes) # Registra o blueprint das rotas de carro na aplicação Flask
